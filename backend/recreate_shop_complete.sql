-- =====================================================
-- ПОВНИЙ СКРИПТ ДЛЯ ПЕРЕСТВОРЕННЯ ВСІХ ТАБЛИЦЬ МАГАЗИНУ
-- =====================================================
...
-- 3. Створення таблиці категорій магазину
...
-- 4. Створення таблиці товарів магазину
...
-- 5. Створення таблиці покупок користувачів
...
-- 6. Створення таблиці активних предметів користувачів
...
-- 7. Створення індексів для швидкого пошуку
...
-- 8. Створення функції для автоматичного оновлення updated_at
...
-- 9. Створення тригерів для автоматичного оновлення updated_at
...
-- 10. Вставка початкових категорій
...
-- 12. Налаштування RLS (вимкнено для публічних даних магазину)
-- Для публічних даних магазину RLS можна вимкнути
ALTER TABLE shop_categories DISABLE ROW LEVEL SECURITY;
ALTER TABLE shop_items DISABLE ROW LEVEL SECURITY;

-- RLS увімкнено тільки для приватних даних користувачів
ALTER TABLE user_purchases ENABLE ROW LEVEL SECURITY;
ALTER TABLE user_active_items ENABLE ROW LEVEL SECURITY;

-- 13. Політики для приватних таблиць
...
-- 15. Показати всі категорії
SELECT * FROM shop_categories ORDER BY id;

-- 16. Показати всі товари з інформацією про категорії
SELECT 
  si.id,
  si.name,
  si.description,
...
-- 17. Показати рекомендовані товари
SELECT 
  id,
  name,
  item_type,
