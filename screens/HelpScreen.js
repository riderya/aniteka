...
const HelpScreen = () => {
  ...
  const faqData = [
    ...
    {
      id: 6,
      question: "Що робити, якщо застосунок працює повільно?",
      answer: "Спробуйте перезапустити застосунок, перевірте підключення до інтернету та переконайтеся, що у вас встановлена остання версія додатку. Також очистіть кеш додатку."
    },
    {
      id: 7,
      ...
      <ContentContainer>
        ...
        >
          ...
          <SectionCard>
            ...
            <SectionText>
              • Регулярно оновлюйте застосунок для отримання нових функцій та виправлень
            </SectionText>
            <SectionText>
